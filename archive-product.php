...
<div class="container" id="container-of-posts">
    ...
    <div class="container-full-archive">
        <div class="container-left-archive">
            <?php
            if (is_active_sidebar('product_archive_sidebar')): ?>
                <aside id="secondary" class="widget-area">
                    <?php dynamic_sidebar('product_archive_sidebar'); ?>
                </aside>
            <?php else: ?>
                <p>Sidebar is not active.</p>
            <?php endif; ?>
        </div>
        <div class="container-right-archive">
            <?php
